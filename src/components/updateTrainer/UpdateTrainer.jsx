...
useEffect(() => {
            ...
            fetch(`${API_BASE_URL}/Admin/GetUserById/${jwtDecode(localStorage.getItem("tokenGYM")).sub}`, {
                ...
                .then((data) => {
                    ...
                    setPhone(data.phone)
                    setSpeciality(data.trainerSpeciality)
                })
                .catch((e) => {
                    alert(e)
                })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/Trainer/UpdateProfile/${jwtDecode(localStorage.getItem("tokenGYM")).sub}`,
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                ...
                <div className="cont-datos">
                    ...
                    <div className="div-form-register">
                        ...
                        <div className="datos-register">
                            ...
                            <select name="" id="" value={speciality} ref={selectSpecialityRef} onChange={(e)=>{setSpeciality(e.target.value)}}>
